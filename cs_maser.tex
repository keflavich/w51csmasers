...
transitions of CS toward the high-mass protostar 
{\color{red} W51 e2e - WE NEED TO STICK TO ONE NOMENCLATURE. I PROPOSE W51-e2e, W51-e8, W51-IRS2/North} with ALMA and the
JVLA.  
...
inversion lines at \sout{55.5} {\color{red} 56.4} \kms \citep{Goddi2016a}.
{\color{red} NOTE THAT IN \citep{Goddi2016a} WE QUOTE 56.4 KM/S in table 4. We used the thinner HF lines, because the main low-JK lines are thick and the high-JK may be tracing redshifted velocities due to infall/rotation. 57.5 is closer to that measured with CH3OH (SEE TABLE 2) }
}
\label{fig:spectra}
\end{figure}
...
% {\color{red} IS THIS TRUE? YOU ONLY SHOW  CHANNEL MAPS OF THE 2-1 , BUT NO THE
% 1-0. DOES IT LOOK LIKE FG. 3?}  In 1-0, we ONLY detect the maser, nothing else.
...
% {\color{red} WHY WOULD IT BE EXCITED? IT SEEMS A AD-HOC EXPLANATION TO ME, NOT
% A *LIKELY* ONE....}  I agree.  I think it is more likely because a hole is
% totally implausible, while high excitation is certain.  But we don't need
% to go into that.
...
either of the masers - I STILL DON'T UNDERSTAND THIS SENTENCE}
in the other HMYSOs in the region, suggests that
