...
peak.
{\color{red} We are basically saying that we cannot constrain the location of
the YSO at that level. I think in goddi+2018 we do some analysis on the
location of the YSO? comparing SiO midpoint and continuum peak. Better to quote
a number - we locate the YSO within X mas.....}  haha X mas
