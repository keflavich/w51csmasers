...
Early single-dish surveys in the Galaxy detected the brightest maser lines of
...
these lines can trace accretion structures, shocks in outflows, and disk winds
in the circumstellar enviroments of protostars.
...
rarity of these masers is so far unexplained, though there is presumably
something unique about the physical conditions producing them.  The conditions
